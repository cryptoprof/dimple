...
class TasksController extends Controller
{
    ...
    {
        //
        return Task::filter($filter)->with(['assignees', 'project', 'customers'])->orderByDesc('id')->paginate(10)->toJson();
    }
    ...
    public function assignToMe(TaskFilter $filter)
    {
        ...
        })->with(['assignees', 'project', 'customers'])->orderByDesc('id')->paginate(10)->toJson();
