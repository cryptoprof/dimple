                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-sm">Месячный доход</p>
                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-sm">Новые лиды</p>
                                        <h5 class="mb-0 font-bold">
                                            12
                                            <span
                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-sm">Заявки</p>
                                        <h5 class="mb-0 font-bold">
                                            +9
                                            <span
                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-sm">Продажи</p>
                                        <h5 class="mb-0 font-bold">
                                            $10,430
                                            <span
                            ...
                            <div class="flex flex-wrap -mx-3">
                                <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                                    <div class="flex flex-col h-full">
                                        <p class="pt-2 mb-1 font-semibold">Новый дашборд</p>
                                        <h5 class="font-bold">Выбирайте задачи и прикрепляйте в виде карточек!</h5>
                                        <p class="mb-12">Сейчас можно закреплять избранные задачи, проекты и клиентов
                                            в виде карточек на нашем дашборде</p>
                    ...
                    <div
                        ...
                        <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                            ...
                            <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                                <h5 class="pt-2 mb-6 font-bold text-white">Работайте с нами</h5>
                                <p class="text-white">Присоединяйтесь к команде разработки!</p>
                            ...
                            <div class="flex flex-wrap mt-0 -mx-3">
                                <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                                    ...
                                    <p class="mb-0 leading-normal text-sm">
                                        ...
                                        <span class="ml-1 font-semibold">30 завершено</span>
                                        за этот месяц
                                    </p>
                                </div>
                ...
                <div class="w-full max-w-full px-3 md:w-1/2 md:flex-none lg:w-1/3 lg:flex-none">
                    <div
                        ...
                        <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                            ...
                            <p class="leading-normal text-sm">
                                ...
                                <span class="font-semibold">24%</span> за прошедший месяц
                            </p>
                        </div>
                        <div class="flex-auto p-4">
                            <div
                      ...
                      <i class="relative z-10 text-transparent ni leading-none ni-bell-55 leading-pro bg-gradient-to-tl from-green-600 to-lime-400 bg-clip-text fill-transparent"></i>
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        <h6 class="mb-0 font-semibold leading-normal text-sm text-slate-700">$2400,
                                            Design changes</h6>
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">22 дек
                                            7:20</p>
                                    </div>
                                </div>
                    ...
                    <span
                      ...
                      <i class="relative z-10 text-transparent ni leading-none ni-html5 leading-pro bg-gradient-to-tl from-red-600 to-rose-400 bg-clip-text fill-transparent"></i>
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        <h6 class="mb-0 font-semibold leading-normal text-sm text-slate-700">Новый лид
                                            #1832412</h6>
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">21 дек
                                            11:32</p>
                                    </div>
                                </div>
                                <div class="relative mb-4 after:clear-both after:table after:content-['']">
