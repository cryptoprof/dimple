            ...
            <div class="flex-none w-full max-w-full px-3">
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6>{{$t('users')}}
                            <router-link :to="{name: 'createUser'}" class="btn btn-success ml-2">
                                <i class="fa fa-user-plus"></i> {{ $t('add') }}
                            </router-link>
                        </h6>
                </div>
                ...
                <section class="">
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        <thead>
                        <tr>
                            <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">{{$t('name')}}</th>
