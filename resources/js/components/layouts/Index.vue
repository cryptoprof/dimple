    ...
    <div>
        ...
        <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
            <div class="h-19.5">
                ...
                <div class="logo py-2.7 text-sm ease-nav-brand my-0 mx-4">
            ...
            <nav id="sidebar" class="sidebar nav-collapse collapse">
                <ul id="side-nav" class="side-nav">
                    <li class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors">
                        <router-link :to="{name:'dashboard'}" class="nav-link">
                            <i class="fa fa-home pr-2"></i> Дашборд
                        </router-link>
                    </li>
                    <li class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" v-if="user.user.UserRoles.includes('admin')">
                    ...
                    <li class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                    ...
                    <li class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                        <router-link :to="{name:'projects'}" class="nav-link">
                            <i class="fa fa-cogs pr-2"></i> Проекты
                        </router-link>
                    </li>
                ...
                <div class="after:opacity-65 after:bg-gradient-to-tl after:from-slate-600 after:to-slate-300 relative flex min-w-0 flex-col items-center break-words rounded-2xl border-0 border-solid border-blue-900 bg-white bg-clip-border shadow-none after:absolute after:top-0 after:bottom-0 after:left-0 after:z-10 after:block after:h-full after:w-full after:rounded-2xl after:content-['']" sidenav-card>
                    ...
                    <div class="relative z-20 flex-auto w-full p-4 text-left text-white">
                        ...
                        <div class="transition-all duration-200 ease-nav-brand">
                            <h6 class="mb-0 text-white">Нужна помощь?</h6>
                            <p class="mt-0 mb-4 font-semibold leading-tight text-xs">Посмотрите в нашу документацию</p>
                            <a href="https://www.creative-tim.com/learning-lab/tailwind/html/quick-start/soft-ui-dashboard/" target="_blank" class="inline-block w-full px-8 py-2 mb-0 font-bold text-center text-black uppercase transition-all ease-in bg-white border-0 border-white rounded-lg shadow-soft-md bg-150 leading-pro text-xs hover:shadow-soft-2xl hover:scale-102">Документация</a>
                        </div>
                    </div>
                </div>
                <!-- pro btn  -->
                        ...
                        <nav>
                            ...
                            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                                <li class="leading-normal text-sm">
                                    <a class="opacity-50 text-slate-700" href="javascript:;">Страницы</a>
                                </li>
