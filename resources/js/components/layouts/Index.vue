        ...
        <aside
            ...
            <div class="h-19.5">
                ...
                <div class="logo py-2.7 text-sm ease-nav-brand my-0 mx-4">
                    <h4>
                        <router-link :to="{name:'dashboard'}" class="nav-link">Dimple <strong>Simple</strong>
                        </router-link>
                    </h4>
                </div>
            </div>
                    ...
                    <div class="relative z-20 flex-auto w-full p-4 text-left text-white">
                        ...
                        <div class="transition-all duration-200 ease-nav-brand">
                            ...
                            <a href="https://www.creative-tim.com/learning-lab/tailwind/html/quick-start/soft-ui-dashboard/"
                               target="_blank"
                               class="inline-block w-full px-8 py-2 mb-0 font-bold text-center text-black uppercase transition-all ease-in bg-white border-0 border-white rounded-lg shadow-soft-md bg-150 leading-pro text-xs hover:shadow-soft-2xl hover:scale-102">Документация</a>
                        </div>
                    </div>
                </div>
                <!-- pro btn  -->
